...
IMPORTANT: As part of the processccc of creating this booster, launch.openshift.io set up a project with a CI/CD deployment of this booster. You can see the status of this deployment in your Single-node OpenShift Cluster or OpenShift Online Web Console. 
...
----
$ git clone git@github.com:${loggedUser}/fmp-test-5
